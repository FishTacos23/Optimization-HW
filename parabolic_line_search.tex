...
\begin{document}
    ...
    \begin{verbatim}
function [a_star, n_objectives] = parabolic_line_search(plot_bool, obj,...
    x, f, s, alpha, mag)
    ...
    a_star = (f_1*(a_2^2-a_3^2)+f_2*(a_3^2-a_1^2)+f_3*(a_1^2-a_2^2))...
        /(2*(f_1*(a_2-a_3)+f_2*(a_3-a_1)+f_3*(a_1-a_2)));
